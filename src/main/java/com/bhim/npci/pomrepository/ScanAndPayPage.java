...
public class ScanAndPayPage {
	...
	@AndroidFindBy(xpath = "//android.widget.FrameLayout[@resource-id='com.google.android.apps.photos:id/fragment_container']")
	private List<WebElement> allFolderNames;

	@AndroidFindBy(xpath = "//android.view.ViewGroup[@content-desc=\"Photo taken on Jul 15, 2023 21:48:51\"]")
